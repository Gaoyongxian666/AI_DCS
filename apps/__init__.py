...
#         self.__db.expire(task_id,900)
#         return  True
#
#     def get_ok_wait(self, timeout=None):
#         item = self.__db.blpop("task-ok", timeout=timeout)
#         return item
#
#     def set_ok_wait(self):
#         self.__db.rpush("task-ok",1)
