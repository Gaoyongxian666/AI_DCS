    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='image/default.png', max_length=500, upload_to='image/%Y/%m', verbose_name='头像')),
                ('signature', models.CharField(default='', max_length=100, verbose_name='个性签名')),
                ('open_id', models.CharField(default='', max_length=100, verbose_name='OPENID')),
                ('nickname', models.CharField(default='', max_length=50, verbose_name='微信昵称')),
